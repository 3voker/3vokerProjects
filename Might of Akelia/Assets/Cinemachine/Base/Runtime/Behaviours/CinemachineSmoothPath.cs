...
namespace Cinemachine
{
    ...
    public class CinemachineSmoothPath : CinemachinePathBase
    {
        ...
        /// <summary>If checked, path starts at point of contact
        [Tooltip("If checked, path starts at point of contact.")]
        ...
        public override Vector3 EvaluatePosition(float pos)
        {
            ...
            if (m_Dynamic)
            {
                result = railCart.transform.position; 
                //Make player == indexA, b
            }
